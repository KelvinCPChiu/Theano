...
from Gaussian_Process_Model import LogisticRegression_2, HiddenLayer, LeNetConvPoolLayer
from Gaussian_Process_Model import shared_dataset_2
...
def main_ver1_sqeu(learning_rate=0.05, weight_decay=0.001, n_epochs=2000, nkerns=[20, 30], data_set='Gaussian_Data_Set.npy', batch_size=500):
    ...
    final_model = Weight_Open('Gaussian_Model_0.05_0.001_[20, 30].pkl')
