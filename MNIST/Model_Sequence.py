...
from Translation_Training import loaddata_mnist
...
def main_ver1_sqeu(learning_rate=0.05, weight_decay=0.001, n_epochs=200, nkerns=[20, 50], dataset='mnist.pkl.gz', batch_size=500):

    rng = numpy.random.RandomState(23455)

    pre_trained_name = 'Mnist_0.05_[20, 50]pt'
...
def main_ver1_sqeu_2(learning_rate=0.05, weight_decay=0.001, n_epochs=200, nkerns=[20, 50], dataset='mnist.pkl.gz', batch_size=500):
...
def converge():
    ...
    temp_model = Weight_Open('Mnist_0.05_[20, 50]pt_Initial.pkl')
    unlearnt_kernels_layer_0 = cross_corre_value(temp_model[3][0], final_model[3][0]) < 0.8
    unlearnt_kernels_layer_1 = cross_corre_value(temp_model[2][0], final_model[2][0]) < 0.8
